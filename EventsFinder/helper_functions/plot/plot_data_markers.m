function plot_data_markers(name,sc,hr,temp,event_struct,color)
...
%   hr_raw: averaged hr 
%   sc_time: sc time corresponding to averaged sc+smoothing
%   sc: averaged sc+smoothing
%   sc_sqi: signal quality index for averaged sc+smoothing
%   hr.time: hr time corresponding to averaged hr+smoothing
%   hr: averaged hr+smoothing
%   temp.time: temperature time corresponding to averaged temp+smoothing
%   temp: averaged temp+smoothing
%   temp.sqi: signal quality index for averaged temp+smoothing
%   event_struct.events: times corresponding to event_struct.events found by Events Finder
%   event_struct.type: number corresponding to marker data type. 
...
%   event_struct.events: navy blue asterisks
