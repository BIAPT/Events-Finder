...
ind_min_ppR20 = find(hrv_features_struct.pRR20 == min(hrv_features_struct.pRR20));
val_min_ppR20 = hrv_features_struct.pRR20(ind_min_ppR20);
time_min_ppR20 = hrv_features_struct.time(ind_min_ppR20);

for i = 1:length(hrv_features_struct.pRR20)
    if (hrv_features_struct.pRR20(i) >= 0.6)
     times_hiHRV = [times_hiHRV,hrv_features_struct.time(i)];
    elseif (hrv_features_struct.pRR20(i) <= 0.3)
...
%Modify HRV features
pRR20_mod = (hrv_features_struct.pRR20*20);
min_ppR20_mod = val_min_ppR20*20;
%Plot HR Subplot
hold on
plot(hr.raw_time,hr.raw,'color',[160/255 160/255 160/255])
plot(hr.time,hr.avg,color)
plot(hrv_features_struct.time,pRR20_mod,'color',[255/255 188/255 0/255]);
plot(time_min_ppR20,min_ppR20_mod,'*','color',[255/255 188/255 0/255]);
grid on
